...
public class HolidayReaderApplication {
    ...
    public static String fileName = "C:\\Users\\luism\\Desktop\\spring-data-jpa\\spring-jpa-logger-h2\\files\\festivity_currencies_YYYYMMDD.csv";
...
//			calendarRepository.save(new Calendario(100, "ABC"));
            ...
            //Read the CSV and save Holidays into the Database
            ...
            log.info(holidayRepository.findById(2L).toString());
